...
<body>
<div class='card'>
<i:form action="/springMVC/patreg" method="post"  >
<h1>SIGN-UP AS A PATIENT</h1>
	 id: <br/> <i:input path="id" /> <br/> 
	Name: <br/> <i:input path="name" /> <br>
	...
	DOB: <br/> <i:input path="dob" /> <br>
	Mobile Num:<br/> <i:input path="mobile" /> <br>
	PAT-NAT: <br/> <i:input path="nativep" /> <br>
